...
const Switch: FC<Props> = ({ isValid }) => {
    ...
    return (
        <div className="switch">
            <div className={"switch-item" + (status === "Runtime" ? " active" : "")} onClick={() => handleChange("Runtime")} data-item={"runtime"}>
                <img src={eye} alt="Картинка" />
                <p>Runtime</p>
            </div>
            <div className={"switch-item" + (status === "Constructor" ? " active" : "")} onClick={() => handleChange("Constructor")} data-item={"constuctor"}>
